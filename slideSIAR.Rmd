...
<p style="color:#00b8e6"> SIAR es un procedimiento metodológico y de visualización que permite analizar la red de transporte e incluir el ámbito espacial. El análisis considera la relación en la ciudad  como lo define Manheim, es decir, <b>Sistema de Transporte, Sistema de Actividades y el Patrón de Flujos.</b></p>   

Esta herramienta posee los siguientes elementos distintivos: 

- Identificar apropiadamente Contexto Espacial

- Herramienta que permite realizar análisis personalizado

- Puede incorporar información con base en la necesidad del analista

- Ayuda a toma de decisiones

- Dinámico, Privado y Reproducible

- Con base en herramientas Open Source
...
Para este primer módulo, los datos necesarios son los siguientes:
...
- **Paradas:** El procedimiento para Paradas es análogo a lo realizado con las Rutas.
